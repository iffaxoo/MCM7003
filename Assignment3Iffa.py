...
app.layout = html.Div([
    ...
    html.Div([
        html.H1("Data Visualization Assignment 3 Iffa", className='display-4 mt-3 mb-4 text-center text-white'),
        html.H2("Dashboard showing graphs", className='mb-4 text-center text-white')
    ], className='container bg', style={'padding': '2rem'}),
    html.Div([
        dcc.Graph(id='covid_cases_fig', figure=create_covid_cases_figure(), className='mb-4'),
        dcc.Graph(id='age_dist_fig', figure=create_age_distribution_figure(), className='mb-4'),
        dcc.Graph(id='gender_pie_chart_fig', figure=create_gender_pie_chart_figure(), className='mb-4')
    ], className='container bg', style={'padding': '2rem'})
